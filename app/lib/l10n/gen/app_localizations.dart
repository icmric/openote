...
abstract class L {
  ...
  /// Import card while a section is being written. {name} is a section name.
  ///
  /// In en, this message translates to:
  /// **'Bringing in \"{name}\" — {done} of {total} pages…'**
  String importBringingIn(String name, int done, int total);

  /// Import card when an import was cancelled.
  ///
  /// In en, this message translates to:
  /// **'Import cancelled.'**
  String get importCancelledLabel;

  /// Import card when everything came over. {count} is a number of pages.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{Imported 1 page.} other{Imported {count} pages.}}'**
  String importDone(int count);

  /// Import card when the import finished but something specific did not come over. {detail} is an English list such as "3 pictures".
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{Imported 1 page, but could not bring {detail}.} other{Imported {count} pages, but could not bring {detail}.}}'**
  String importDoneButLost(int count, String detail);

  /// Import card when the chosen notebook had no pages at all.
  ///
  /// In en, this message translates to:
  /// **'That notebook had no pages in it.'**
  String get importEmptyNotebook;

  /// Import card when nothing at all came over.
  ///
  /// In en, this message translates to:
  /// **'That notebook could not be brought over.'**
  String get importFailedGeneric;

  /// Import card the moment the page total is known and pages start arriving. {count} is a number of pages.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{1 page to bring over. Starting now…} other{{count} pages to bring over. Starting now…}}'**
  String importFoundPages(int count);

  /// Import card once the sections are counted but their pages are not. {count} is a number of sections.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{Found 1 section — seeing what is in it…} other{Found {count} sections — seeing what is in them…}}'**
  String importFoundSections(int count);

  /// Import card during the wait before any page can arrive, when nothing is known yet.
  ///
  /// In en, this message translates to:
  /// **'Looking through your notebook…'**
  String get importLookingAround;

  /// Import card when something unexpected stopped the import but pages had already arrived. {count} is a number of pages.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{Something went wrong partway through, but the 1 page already brought over is here. Openote will finish the rest on its own later.} other{Something went wrong partway through, but the {count} pages already brought over are here. Openote will finish the rest on its own later.}}'**
  String importPartialBroke(int count);

  /// Import card when Microsoft throttled the import to a stop but pages had already arrived. {detail} is Microsoft's own explanation, in English.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{{detail} The 1 page already brought over is here. Openote will finish the rest on its own later, or you can start it again whenever you like.} other{{detail} The {count} pages already brought over are here. Openote will finish the rest on its own later, or you can start it again whenever you like.}}'**
  String importPartialThrottled(String detail, int count);

  /// Import card while a OneNote package file is being read.
  ///
  /// In en, this message translates to:
  /// **'Reading the notebook…'**
  String get importReading;

  /// Import card while getting permission from Microsoft.
  ///
  /// In en, this message translates to:
  /// **'Signing in to OneNote…'**
  String get importSigningIn;

  /// Import card after the user stopped an import that had already brought pages over. {count} is a number of pages.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{Stopped — kept the 1 page already brought in. You can finish it whenever you like.} other{Stopped — kept the {count} pages already brought in. You can finish it whenever you like.}}'**
  String importStoppedKept(int count);

  /// Import card after Stop is pressed.
  ///
  /// In en, this message translates to:
  /// **'Stopping…'**
  String get importStopping;

  /// Import card while Microsoft has asked the app to slow down. {seconds} counts down.
  ///
  /// In en, this message translates to:
  /// **'Microsoft has asked Openote to slow down — carrying on in {seconds}s. Nothing already brought in is lost.'**
  String importThrottled(int seconds);

  /// Import card while waiting less than a second for Microsoft.
  ///
  /// In en, this message translates to:
  /// **'Microsoft has asked Openote to slow down — carrying on in a moment. Nothing already brought in is lost.'**
  String get importThrottledSoon;

  /// Import card while a OneNote package file is being written out. {count} is a number of pages.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{Importing 1 page…} other{Importing {count} pages…}}'**
  String importWritingPages(int count);

  /// Import card naming the section being written. {name} is a section name.
  ///
  /// In en, this message translates to:
  /// **'Importing \"{name}\"…'**
