...
class LFr extends L {
  ...
  String importBringingIn(String name, int done, int total) {
    return 'Récupération de « $name » — $done sur $total pages…';
  }

  @override
  String get importCancelledLabel => 'Importation annulée.';
  ...
  String importDoneButLost(int count, String detail) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count pages importées, mais impossible de récupérer $detail.',
      one: '1 page importée, mais impossible de récupérer $detail.',
    );
    return '$_temp0';
  }

  @override
  String get importEmptyNotebook => 'Ce carnet ne contenait aucune page.';

  @override
  String get importFailedGeneric => 'Ce carnet n\'a pas pu être récupéré.';
  ...
  String importFoundPages(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count pages à récupérer. C\'est parti…',
      one: '1 page à récupérer. C\'est parti…',
    );
    return '$_temp0';
  }
  ...
  String importFoundSections(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count sections trouvées — examen de leur contenu…',
      one: '1 section trouvée — examen de son contenu…',
    );
    return '$_temp0';
  }

  @override
  String get importLookingAround => 'Examen de votre carnet…';
  ...
  String importPartialBroke(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Quelque chose s\'est mal passé en route, mais les $count pages déjà récupérées sont là. Openote terminera le reste tout seul plus tard.',
    );
    return '$_temp0';
  }
  ...
  String importPartialThrottled(String detail, int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          '$detail Les $count pages déjà récupérées sont là. Openote terminera le reste tout seul plus tard, ou vous pouvez relancer quand vous voulez.',
    );
    return '$_temp0';
  }

  @override
  String get importReading => 'Lecture du carnet…';

  @override
  String get importSigningIn => 'Connexion à OneNote…';
  ...
  String importStoppedKept(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Arrêté — les $count pages déjà récupérées sont conservées. Vous pouvez terminer quand vous voulez.',
      one:
          'Arrêté — la page déjà récupérée est conservée. Vous pouvez terminer quand vous voulez.',
    );
    return '$_temp0';
  }

  @override
  String get importStopping => 'Arrêt…';

  @override
  String importThrottled(int seconds) {
    return 'Microsoft a demandé à Openote de ralentir — reprise dans ${seconds}s. Rien de ce qui est déjà arrivé n\'est perdu.';
  }

  @override
  String get importThrottledSoon =>
      'Microsoft a demandé à Openote de ralentir — reprise dans un instant. Rien de ce qui est déjà arrivé n\'est perdu.';
  ...
  String importWritingPages(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Importation de $count pages…',
      one: 'Importation de 1 page…',
    );
    return '$_temp0';
  }
